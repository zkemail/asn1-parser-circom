...
export const SAMPLE_X_509: number[] = [];
export const SAMPLE_DER: number[] = [];
export const SAMPLE_BER: number[] = [];

// export const X_509_CONTENT =
// Array.from(readAndParseDer("../assets/X.509.txt"));
// Array.from(readAndParseDer("../assets/sig-p256-der.txt"));
// Array.from(readAndParseDer("../assets/sig-p256-ber.txt"));
